...
console.log("PUBLIC KEY:", import.meta.env.VITE_PUBLIC_KEY);
  ...
  emailjs
    .send(
      ...
      {
        from_name: form.name,
        to_name: "Dhara Vadagasiya",
        from_email: form.email,
        to_email: "dharavadagasiya3502@gmail.com",
        ...
        >
          <label className='flex flex-col'>
            ...
            <input
              ...
              className='black-100 py-4 px-6 placeholder:text-secondary text-white rounded-lg outline-none border-none font-medium'
            />
          </label>
          <label className='flex flex-col'>
          ...
          <button
            type='submit'
            className='black-100 py-3 px-8 rounded-xl outline-none w-fit text-white font-bold shadow-md shadow-primary'
          >
